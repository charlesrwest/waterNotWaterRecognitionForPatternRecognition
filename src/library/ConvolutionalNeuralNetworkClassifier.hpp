...
class ConvolutionalNeuralNetworkClassifier : public classifierBaseClass
{
public:
...
virtual ~ConvolutionalNeuralNetworkClassifier() {}
...
std::unique_ptr<caffe::Net<float>> network;
};
